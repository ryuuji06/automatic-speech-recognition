...
# usage example
# python create_desc_json.py C:\datasets\LibriSpeech\dev-clean\ corpus_clean_dev.json
# python create_desc_json.py C:\datasets\LibriSpeech\test-clean\ corpus_clean_dev.json
